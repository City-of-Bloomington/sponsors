...
public class SponSearchServ extends TopServlet{
	...
	out.println("<input id=\"c_ame\" name=\"c_name\" size=\"20\" maxlength=\"50\" value=\""+c_name+"\" /></td>");		
	out.println("<td class=\"left\">");
	...
	out.println("</tr>");
	out.println("<tr><td class=\"left\">");
	out.println("<input name=\"c_address\" size=\"12\" maxlength=\"20\" value=\""+c_address+"\" /></td>");		
	out.println("<td class=\"left\">");
	out.println("<input name=\"c_city\" size=\"12\" maxlength=\"20\" value=\""+c_city+"\" /></td>");
	out.println("<td class=\"left\">");
	out.println("<input name=\"c_phone\" size=\"12\" maxlength=\"20\" value=\""+c_phone+"\" /></td>");
	out.println("</tr>");
	out.println("</table></td></tr>");
	out.println("</table></td></tr>");
	out.println("<tr><td><table width=\"80%\">");
	out.println("<tr><th>Records Per Page ");
	out.println("<input name=\"pageSize\" size=\"3\" maxlength=\"3\" value=\""+pageSize+"\" /></th>");
	out.println("<th>Sort By ");
