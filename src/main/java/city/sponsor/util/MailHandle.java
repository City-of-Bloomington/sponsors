...
public class MailHandle{
    ...
    static String to = "";
    static String from = "";
    static String host = "localhost"; // whoville.city. ...
    static boolean debug = true;
    static String subject = "sponsorship";
     ...
     */
    public MailHandle( String to2, String from2, String subject2, String msg2, String cc2, String bcc2, boolean debug2){
